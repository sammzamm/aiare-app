  ...
  return knex('observational_data').del()
    .then(function() {
      ...
      return knex('observational_data').insert([{
          id: 1,
          owner_id: 1,
          date_time: new Date("2017-07-01 15:32:21.617209-06"),
          location: 'RMNP',
          sub_region: 'McHenrys',
        ...
        },
        {
          ...
          forecast_wind: 50,
          forecast_gust: 60,
          forecast_notes: 'high winds with low visibility and cold temps.  Steady snow throughout the day with accumulation under 4 inches.',
          actual_low_temp: -11,
          actual_high_temp: 2,
